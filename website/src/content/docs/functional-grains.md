---
title: "Functional Runtime Reference"
description: "Complete reference for typed API-record contracts, handlers, lifecycle, placement, transactions, and hosting."
---
...
on this page and covered end to end in [Server-Streaming Replies](/orleans-fsharp/streaming-replies/).
...
[Serialization](/orleans-fsharp/serialization/#versioned-state-and-upcasters) and
[Event Sourcing](/orleans-fsharp/event-sourcing/#versioned-events-and-snapshots).
...
Migration from the original authoring model is documented separately in [Legacy API Migration](/orleans-fsharp/legacy/migration/).
