...
It is retained as an unsupported migration reference under the [Legacy archive](/orleans-fsharp/legacy/),
...
verified boundaries in [Release and Production Status](/orleans-fsharp/release-status/), then validate storage
