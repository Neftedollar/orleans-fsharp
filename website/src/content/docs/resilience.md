---
title: "Grain Resilience"
description: "Polly v8 retry, circuit-breaker, and timeout patterns for grain calls."
---
...
> **Current API.** The examples wrap ordinary functional API-record calls. The original handle example is retained in [Legacy Resilience](/orleans-fsharp/legacy/resilience/).
...
[functional grain runtime](/orleans-fsharp/functional-grains/), whose token reaches the handler through
