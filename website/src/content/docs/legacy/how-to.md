---
title: "Legacy: How To"
description: "Archived tutorial for the original Orleans.FSharp authoring API."
---

# Legacy How To

> This archived tutorial uses the original Orleans.FSharp authoring API. It remains available for maintaining existing applications; new applications should use the current [How To](/orleans-fsharp/how-to/).
...
- [Legacy: Grain Definition](/orleans-fsharp/legacy/grain-definition/) -- all 27 keywords in the `grain {}` CE (deprecated model, kept for reference)
