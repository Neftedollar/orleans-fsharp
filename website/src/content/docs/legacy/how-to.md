...
> applications should use the current [How To](/orleans-fsharp/how-to/).
...
[Silo Configuration](/orleans-fsharp/silo-configuration/), and [Security](/orleans-fsharp/security/) for current guidance.
