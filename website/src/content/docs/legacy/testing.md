...
description: "Testing patterns for the original Orleans.FSharp APIs."
---
...
> set. Current testing guidance lives in [Testing](/orleans-fsharp/testing/).
...
For `grainContract`, `grainFor`, and `journaledGrainFor`, see [Testing](/orleans-fsharp/testing/).
