...
in [Getting Started](/orleans-fsharp/getting-started/):
...
- [Grain Definition](/orleans-fsharp/grain-definition/) -- the grain definitions you are testing (deprecated model, kept for reference)
