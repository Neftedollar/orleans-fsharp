...
<CardGrid>
  ...
  <LinkCard title="Functional Grain Runtime" href="/orleans-fsharp/functional-grains/" description="Typed API records, contracts, handlers, persistence, lifecycle, and concurrency." />
