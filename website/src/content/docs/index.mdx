...
:::note[Maintaining an existing application?]
Documentation for earlier Orleans.FSharp authoring models is preserved in the separate
[Legacy API section](/orleans-fsharp/legacy/). Current guides and examples use only the functional runtime.
:::
...
The source-checkout install is temporary: the published template package 4.1.0 still creates the
Legacy project shape.
