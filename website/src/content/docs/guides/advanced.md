...
description: Transactions, grain directory, OpenTelemetry, graceful shutdown, state migration, serialization, and more
---
...
- [Grain Definition](/orleans-fsharp/guides/grain-definition/) -- use these features in grain definitions
- [Silo Configuration](/orleans-fsharp/guides/silo-configuration/) -- configure providers for these features
