...
See [Serialization](../serialization.md) before changing a format in a deployed application.
...
- [Persistence model](../functional-grains.md#persistence-model)
- [Lifecycle hooks](../functional-grains.md#activation-ordering-and-lifecycle-hooks)
- [Timers, reminders, and collection age](../functional-grains.md#timers-reminders-and-collection-age)
- [Versioned state and upcasters](../serialization.md#versioned-state-and-upcasters)
- [Journal state and snapshots](../event-sourcing.md)
