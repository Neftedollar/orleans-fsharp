...
> `[<Obsolete>]` (warning, not error). See [functional-grains.md](functional-grains.md) for the
...
definition; see the persistence model in [functional-grains.md](functional-grains.md).
...
activation, since `FunctionalGrainContext`'s constructor is internal. See [Testing](testing.md) for
...
functional runtime above -- see [functional-grains.md](functional-grains.md) for the complete
