...
[`grainFor`](functional-grains.md). Three things change, and nothing else:
...
See [calling-from-csharp.md](calling-from-csharp.md).
...
> the functional grain runtime (above, and [functional-grains.md](functional-grains.md)). The
...
- [Functional Grains](functional-grains.md) -- the `grainContract` / `grainFor` model this builds on
- [Calling from C#](calling-from-csharp.md) -- the facade over a journaled contract
- [Testing](testing.md) -- property testing of folds and handlers
