...
> **Current API.** This page complements the functional runtime guide. Historical CodeGen patterns are retained in [Legacy Advanced Patterns](legacy/advanced.md).
