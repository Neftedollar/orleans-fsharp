...
[Serialization](serialization.md#durable-persistence-codecs) for silo defaults, custom JSON
...
[Release and Production Status](release-status.md#stateless-worker-implicit-streams-require-orleans-103).
