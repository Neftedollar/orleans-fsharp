...
See [functional-grains.md](../functional-grains.md) for the complete guide, including
...
- [Functional Grain Runtime](../functional-grains.md) -- the current authoring model, full guide
- [Legacy: Grain Definition](grain-definition.md) -- all 27 keywords in the `grain {}` CE (deprecated model, kept for reference)
- [Event Sourcing](../event-sourcing.md) -- `journaledGrainFor { }`, a grain whose state is the fold of an event journal
- [Testing](../testing.md) -- TestHarness, GrainMock, and property tests
- [API Reference](../api-reference.md) -- complete module and function reference
