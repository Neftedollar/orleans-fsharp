...
> Current functional transactions are documented in [Functional Grain Runtime](../functional-grains.md#distributed-acid-transactions).
...
The complete original grain, timer, reminder, scripting-handle, and registration surfaces are indexed in [Legacy API Reference](api-reference.md) and [Legacy Grain Definition](grain-definition.md).
