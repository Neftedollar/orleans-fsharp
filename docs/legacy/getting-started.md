...
> This page is intentionally isolated from the current functional API documentation. It covers the deprecated API kept for existing applications; new applications should start with [Getting Started](../getting-started.md).
