...
documented Orleans stages -- see [Lifecycle-stage hooks](../functional-grains.md#lifecycle-stage-hooks-onlifecycle)
...
[Push to clients: functional observers](../functional-grains.md#push-to-clients-functional-observers). The one
